...
const Year40DepartmentLeaderEducation = () => {
  const playlistId = "PLOZKPu82muDxXjh9dkkeU8ZYfYWiYcq0P"
  const maxResults = 5
    ...
    <GeneralLayout>
      ...
      <PageTitle borderRadius={"5px"}>
        <Typography
          ...
          color={"#FFF"}
        >
          Year 40 Department Leaders Education
        </Typography>
      </PageTitle>
...
export default Year40DepartmentLeaderEducation
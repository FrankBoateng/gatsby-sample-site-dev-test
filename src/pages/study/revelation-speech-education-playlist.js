...
const RevelationSpeechEducation = () => {
  const playlistId = "PLOZKPu82muDxm14GSsxMJHc53fGMIjTZl"
  ...
  return (
    <GeneralLayout>
      ...
      <Seo title="Revelation 10 minutes Speech Education" />
        <PageTitle borderRadius={"5px"}>
          <Typography id="page-title" variant="h5" color={"#FFF"}>
            Revelation 10 minutes Speech Education
          </Typography>
        </PageTitle>
...
export default RevelationSpeechEducation

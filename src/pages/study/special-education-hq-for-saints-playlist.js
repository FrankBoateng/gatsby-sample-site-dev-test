...
const SpecialEducationFromHQForAllSaints = () => {
  const playlistId = "PLOZKPu82muDyrdrZazMAijxzE8X3rhUmA"
  ...
  return (
    <GeneralLayout>
      <Button id="back-button" variant="contained" component={Link} to="/study/study-video-material-categories" startIcon={<KeyboardBackspaceIcon />}>
        Back
      </Button>


      <Seo title="Special Education from HQ for all saints" />
        <PageTitle borderRadius={"5px"}>
          <Typography id="page-title" variant="h5" color={"#FFF"}>
            Special Education from HQ for all saints
          </Typography>
        </PageTitle>
...
export default SpecialEducationFromHQForAllSaints

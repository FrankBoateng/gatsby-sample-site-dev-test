...
const TrainingMaterialforTheologyWOD = () => {
  const playlistId = "PLOZKPu82muDy2BHXbcb0Wt2QMyh7n-9xl"
  const maxResults = 5
  ...
  useEffect(() => {
    ...
    const playlistApi = `https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=${playlistId}&key=AIzaSyDw_UkHAg_7HW2jtCTCcr4zHZRwqoZnpdI&pageToken=${
    ...
    <GeneralLayout>
      ...
      <PageTitle borderRadius={"5px"}>
        <Typography
          ...
          color={"#FFF"}
        >
          12 Tribes Church Head, Instructor, Evangelist Special Education (Year
          39~40)
        </Typography>
      </PageTitle>
          ...
          return (
            <li>
              <TrainingCard
                ...
                xs={12}
                component={Link}
                to={`/youtube-player?video=${video?.resourceId?.videoId}`}
